...
class Wrangler(object):
    ...
    def _run(self):
        ...
        save_counts = Counter(chain.from_iterable(n.outputs for n in nodes))
        ...
        for node in self._pipeline.nodes:
            ...
            for data_set in node_inputs:
                ...
                # modified condition of dataset release.
                # if (load_counts[data_set] < 1) and (data_set not in pipeline_inputs) and (save_counts.get(data_set, 0)==0):
